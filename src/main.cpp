...
#if defined(NDEBUG)
# error "VRSCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "VRSCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if(nHeight == 1)
    {
        nSubsidy = 270000000 * COIN;   //270M Premine 
    }
        else
    {
        nSubsidy = 0 * COIN;
